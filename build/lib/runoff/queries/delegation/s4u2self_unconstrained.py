...
def get_s4u2self_unconstrained(
    ...
    RETURN
        ...
        CASE WHEN 'admin_tier_0' IN COALESCE(n.system_tags, []) OR n:Tag_Tier_Zero THEN 'T0' ELSE '' END AS tier_zero,
    ...
    if results:
        ...
        console.print()
        console.print("    Exploitation:", style="text.secondary")
        console.print(
            "    # Get TGS for DA via S4U2Self (bypass 'sensitive' flag)", style="text.secondary"
        )
        console.print(
