...
def get_abuse_commands(edge_type: str, target_type: str) -> dict[str, Any] | None:
    ...
    result: dict[str, Any] | None = edge_data.get(target_type)
    return result


def get_query_abuse_commands(query_name: str) -> dict[str, Any] | None:
