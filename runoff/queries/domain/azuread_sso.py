...
def get_azuread_sso(bh: BloodHoundCE, domain: str | None = None, severity: Severity = None) -> int:
    ...
    if results:
        ...
        console.print()
        console.print("    Attack vector:", style="text.secondary")
        console.print("    1. Extract NTLM hash of AZUREADSSOACC$ from AD", style="text.secondary")
        console.print("    2. Forge Kerberos tickets for cloud users", style="text.secondary")
        console.print(
            "    3. Access Azure/M365 resources as any synced user", style="text.secondary"
        )
        console.print()
        console.print(
            "    Detection: Monitor for unusual ticket requests against this account",
            style="text.dim",
        )
        console.print()
