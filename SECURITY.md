...
2. Open a private security advisory at [GitHub Security Advisories](https://github.com/Real-Fruit-Snacks/runoff/security/advisories/new)
...
- Use environment variables for sensitive values:
  ```bash
  export RUNOFF_NEO4J_PASSWORD="your-password"
  python -m runoff -p "$RUNOFF_NEO4J_PASSWORD" -a
  ```
